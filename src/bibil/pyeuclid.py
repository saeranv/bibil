...
class Line2(Geometry):
    ...
    def __init__(self, *args):
        if len(args) == 3:
            ...
            #chk:
            #print isinstance(args[0], Point2)
            #print isinstance(args[1], Point2)
...
sc.sticky["Point2"] = Point2
sc.sticky["LineSegment2"] = LineSegment2
sc.sticky["Geometry"] = Geometry
sc.sticky["Line2"] = Line2
