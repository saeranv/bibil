    ...
    def helper_geom2node(self,geom,parent_node,label=""):
        ...
        try:
            ...
            try:
                ...
                child_shape = Shape_3D(geom,parent_node.shape.cplane)
    ...
    def court(self,temp_node_,PD_):        
        def helper_court_refcrv(court_ref_,subdiv_):
            ...
            #Check if node ref
                ...
                refshape_ = court_node_.shape
            #Check if geometry ref
            return refshape_  
